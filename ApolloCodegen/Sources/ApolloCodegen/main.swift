...
struct SwiftScript: ParsableCommand {
    ...
    struct DownloadSchema: ParsableCommand {
        ...
        func run() throws {
            ...
            let folderForDownloadedSchema = fileStructure.sourceRootURL
                .apollo.childFolderURL(folderName: "RickAndMortyWorkshop")
    ...
    struct GenerateCode: ParsableCommand {
        ...
        func run() throws {
          ...
          let projectURL = fileStructure.sourceRootURL
            .apollo.childFolderURL(folderName: "RickAndMortyWorkshop")

            let targetRootURL = fileStructure.sourceRootURL
                .apollo.childFolderURL(folderName: "RickAndMortyWorkshop")
                .apollo.childFolderURL(folderName: "Services")
                .apollo.childFolderURL(folderName: "RickAndMortyClient")
            ...
            try ApolloCodegen.run(from: projectURL,
